...
exports.resetUserPassword =
  exports.forgetUserPassword =
  exports.verifyUserAccount =
  exports.createUser =
    void 0;
...
const verifyUserAccount = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (
        (accountUser === null || accountUser === void 0
          ? void 0
          : accountUser.verifyToken) === token
      ) {
        const user = yield myUserModel_1.default.findByIdAndUpdate(
          userID,
          {
            verifyToken: "",
            verify: true,
...
const forgetUserPassword = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (
        getUser &&
        (getUser === null || getUser === void 0 ? void 0 : getUser.verify)
      ) {
        const user = yield myUserModel_1.default.findByIdAndUpdate(
          getUser === null || getUser === void 0 ? void 0 : getUser._id,
          {
            verifyToken: token,
          },
          { new: true }
